...
export default function RootLayout({
  ...
  return (
    <html lang="en" data-theme="dark">
      <Head>
        {/* General Meta Tags */}
        <meta name="title" content="TheGoodPlace - Build Founder Conviction Before Code" />
        <meta name="description" content="TheGoodPlace is an AI-driven platform designed to help founders and entrepreneurs build conviction around their ideas through validation." />

        {/* Open Graph / Facebook */}
        <meta property="og:type" content="website" />
        <meta property="og:url" content="https://www.TheGoodPlace.com/" />
        <meta property="og:title" content="TheGoodPlace - Build Founder Conviction Before Code" />
        ...
        <meta name="twitter:title" content="TheGoodPlace - Build Founder Conviction Before Code" />
